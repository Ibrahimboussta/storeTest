    ...
    <main className="pt-32 pb-20 px-5 flex items-center justify-center min-h-screen bg-surface-container-lowest">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="font-headline-lg text-2xl font-semibold mb-2">Bon retour</h1>
          <p className="font-body-md text-on-surface-variant">Accédez à votre compte premium</p>
        </div>
        ...
        <form action={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="#" className="text-[10px] font-label-md uppercase tracking-widest text-primary hover:opacity-70 transition-opacity">Oublié ?</Link>
            </div>
            <div className="relative">
        ...
        <p className="text-center mt-8 font-body-md text-on-surface-variant text-sm">
          ...
          <Link href="/register" className="text-primary font-semibold hover:border-b border-primary transition-all">S'inscrire</Link>
        </p>
      </motion.div>
    </main>
  );
